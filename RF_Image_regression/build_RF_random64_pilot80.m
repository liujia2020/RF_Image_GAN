clc; clear; close all;
% ============================================================
% Random64 pilot RF learning sample generation
%
% Purpose:
%   Generate a small nonpoint pilot dataset for 64 x 32 x 32 patches.
%
% Selection:
%   Categories : carotid, muscle, phantom
%   Per category: train/val/test = 19/4/4 files
%   Total files : 3 * (19 + 4 + 4) = 81
%   Patches     : one random patch per RF file
%
% Patch:
